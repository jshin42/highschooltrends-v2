...
export class SilverDatabaseMigration {
  ...
  private async runMigration(version: string, description: string): Promise<void> {
...
export async function initializeSilverDatabase(databasePath: string): Promise<void> {
