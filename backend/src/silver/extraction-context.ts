...
export class SilverExtractionContext implements ExtractionContext {
  public bronzeRecord: BronzeRecord;
  public schoolSlug: string;
  public sourceYear: number;
  public fileContent: string;
  public domDocument: Document | null = null;
  ...
  private extractSourceYearFromPath(filePath: string): number {
